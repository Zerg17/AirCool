...
void rccInit(){
    ...
    RCC->APB2ENR |= RCC_APB2ENR_USART1EN | RCC_APB2ENR_ADCEN | RCC_APB2ENR_SPI1EN;
...
void gpioInit(){
    ...
    GPIOA->MODER |= GPIO_MODER_MODER0_Msk | GPIO_MODER_MODER0_Msk | GPIO_MODER_MODER0_Msk | GPIO_MODER_MODER0_Msk;
    ...
    //GPIOA->MODER |= GPIO_MODER_MODER0_Msk | GPIO_MODER_MODER2_1 | GPIO_MODER_MODER3_1 | GPIO_MODER_MODER9_1 | GPIO_MODER_MODER10_1 | GPIO_MODER_MODER11_0;
